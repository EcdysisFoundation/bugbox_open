...
# Torchserve is down
AI_INFERENCE_URL = 'http://10.147.19.124:8070/metaformer-predict'
...
MIGRATION_MODULES = {"sites": "bugbox3.contrib.sites.migrations"}
...
ADMINS = [("Mikayla Electra Wilson", "mikayla.wilson@ecdysis.bio"),
          ("Diaa Nassar", "diaa.nassar@ecdysis.bio")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "bugbox3.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "bugbox3.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "bugbox3.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "bugbox3.users.forms.UserSocialSignupForm"}
