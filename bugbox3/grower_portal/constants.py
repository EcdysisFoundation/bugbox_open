...
AREA_SAMPLED_HA_MIN = 0.04
AREA_SAMPLED_HA_MAX = 4046.86
AVERAGE_WEIGHT_KG_MIN = 0.45
AVERAGE_WEIGHT_KG_MAX = 2268
...
DEFAULT_AREA_UNIT = AREA_UNIT_ACRES
CANONICAL_AREA_UNIT = AREA_UNIT_HECTARES

DEPTH_UNIT_INCHES = 'inches'
DEPTH_UNIT_CM = 'cm'
DEPTH_UNIT_CHOICES = [
    (DEPTH_UNIT_INCHES, 'Inches'),
    (DEPTH_UNIT_CM, 'Centimeters'),
]
DEFAULT_DEPTH_UNIT = DEPTH_UNIT_INCHES
CANONICAL_DEPTH_UNIT = DEPTH_UNIT_CM
...
DEFAULT_WEIGHT_UNIT = WEIGHT_UNIT_LBS
CANONICAL_WEIGHT_UNIT = WEIGHT_UNIT_KG
...
DEFAULT_TIME_UNIT = TIME_UNIT_DAYS
