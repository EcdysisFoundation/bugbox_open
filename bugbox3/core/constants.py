...
STITCHER_LABEL_STUDIO_PROJECT_CREATED_AT = 'label_studio_project_created_at'
STITCHER_LABEL_PROJECT_DIR = 'label_project_dir'
STITCHER_LABEL_FILE = 'label_file'
STITCHER_LABEL_FILE_UPDATED_AT = 'label_file_updated_at'
STITCHER_STITCHING_EXCEPTION = 'stitching_exception'
STITCHER_STITCHING_EXCEPTION_AT = 'stitching_exception_at'
STITCHER_PANORAMA_TIMESTAMP = 'panorma_timestamp'
...
STITCHER_TIMEFIELDS = [
    ...
    STITCHER_CREATED_AT,
    STITCHER_LABEL_FILE_UPDATED_AT,
    STITCHER_LABEL_STUDIO_PROJECT_CREATED_AT,
    STITCHER_BUGBOX_REJECTED
]
STITCHER_FORM_IDENT = 'form_ident'
STITCHER_FORM_DEFAULT = 'defaultValue'
STITCHER_FORM_CROPSAVE = 'cropSave'
STITCHER_FORM_CROPSAVE_CVAT = 'cropSaveCvat'
STITCHER_FORM_POST_CROPPED = 'editPostCropped'
