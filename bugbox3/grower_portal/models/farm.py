...
class Field(models.Model):
    ...
    paddock_size_ha = models.DecimalField(
    ...
    paddock_size_entered = models.DecimalField(
    ...
    paddock_size_unit = models.CharField(
    ...
    area_sampled_ha = models.DecimalField(
        ...
        validators=[MinValueValidator(AREA_SAMPLED_HA_MIN), MaxValueValidator(AREA_SAMPLED_HA_MAX)],
    ...
    area_sampled_entered = models.DecimalField(
    ...
    area_sampled_unit = models.CharField(
